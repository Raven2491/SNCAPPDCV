    ...
    return await showDialog<bool>(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: const Text(
                  'Estimado usuario, Rapidito requiere que habilite su GPS. ¿Desea habilitarlo?'),*/
              title: const Text('Habilitar GPS'),
              content: const Text(
                  'El GPS está deshabilitado. ¿Desea habilitarlo para continuar?'),
              actions: [
                TextButton(
                  child: const Text('No'),
                  onPressed: () {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Volver a cargar la aplicación'),
          actions: [
            TextButton(
